...
let myFirstBlogPost: BlogPost = new BlogPost('John Doe', 'Lorem Ipsum', 'Lorem ipsum dolor sit amet.', '2000.05.04');
let mySecondBlogPost: BlogPost = new BlogPost('Tim Urban', 'Wait but why', 'A popular long-form, stick-figure-illustrated blog about almost everything.', '2010.10.10');
let myThirdBlogPost: BlogPost = new BlogPost('William Turton', 'One Engineer Is Trying to Get IBM to Reckon With Trump',
...
console.log(myFirstBlogPost);
console.log(mySecondBlogPost);
console.log(myThirdBlogPost);